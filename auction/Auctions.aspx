<%@ Page language="c#" Codebehind="Auctions.aspx.cs" AutoEventWireup="True" Inherits="SoftwareSolutions.Auction.Auctions" %>
    ...
    <div class="PageLayout">
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datalist id="dlListings" runat="server" BorderStyle="None" 
                BorderWidth="0px" EnableViewState="False" RepeatLayout="Table" Height="247px" >
				<HeaderTemplate>
